 ...
 * Basic Types
 */
inline unsigned int GetSerializeSize(char a,      int, int=0) { (void) a; return 1; }
inline unsigned int GetSerializeSize(int8_t a,    int, int=0) { (void) a; return 1; }
inline unsigned int GetSerializeSize(uint8_t a,   int, int=0) { (void) a; return 1; }
inline unsigned int GetSerializeSize(int16_t a,   int, int=0) { (void) a; return 2; }
inline unsigned int GetSerializeSize(uint16_t a,  int, int=0) { (void) a; return 2; }
inline unsigned int GetSerializeSize(int32_t a,   int, int=0) { (void) a; return 4; }
inline unsigned int GetSerializeSize(uint32_t a,  int, int=0) { (void) a; return 4; }
inline unsigned int GetSerializeSize(int64_t a,   int, int=0) { (void) a; return 8; }
inline unsigned int GetSerializeSize(uint64_t a,  int, int=0) { (void) a; return 8; }
inline unsigned int GetSerializeSize(float a,     int, int=0) { (void) a; return 4; }
inline unsigned int GetSerializeSize(double a,    int, int=0) { (void) a; return 8; }
...
inline unsigned int GetSerializeSize(bool a, int, int=0)                          { (void) a; return sizeof(char); }
